...
echo "  3. Start vLLM with UI-TARS (4-bit GPTQ, fits 16GB VRAM):"
echo "     vllm serve yujiepan/ui-tars-1.5-7B-GPTQ-W4A16g128 --max-model-len 4096 --port 8080 --trust-remote-code --gpu-memory-utilization 0.9"
echo "  4. Run the agent:  python3 main.py"
